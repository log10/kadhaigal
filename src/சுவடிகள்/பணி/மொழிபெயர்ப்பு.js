...
export const மொழிபெயர்ப்பு_பணி = {
    ...
    கதையைத்தா: (நூற்பெயர், இயற்பெயர்) => {
        ...
        if(மொழிபெயரியல்கள்[பெயர்] === undefined) {
            return (இயற்பெயர் ? _மொழிபெயரியல்கள்[நூற்பெயர்][இயற்பெயர்].கரு : _மொழிபெயரியல்கள்[நூற்பெயர்])()
                .then(கதை => {
    ...
    விளக்கம்: (நூற்பெயர், இயற்பெயர்) => {
        if (!இயற்பெயர்) {
           return _மொழிபெயரியல்கள்[நூற்பெயர்].விளக்கம்
        }
        return _மொழிபெயரியல்கள்[நூற்பெயர்][இயற்பெயர்].விளக்கம்;
    }
};